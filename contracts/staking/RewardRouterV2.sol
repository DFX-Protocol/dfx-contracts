...
contract RewardRouterV2 is IRewardRouterV2, ReentrancyGuard, Governable
{
    ...
    // TODO: Refactor? As of 0.8.20 needs to be compiled with viaIR or there will be an unsolvable Stack to deep compile error.
    // Quick Fix. Moved the "constant" weth to constructor.
    function initialize(
        address gmx_,
        address _esGmx,
        address _bnGmx,
