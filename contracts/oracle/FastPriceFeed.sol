...
import { ISecondaryPriceFeed } from "./PriceFeed.sol";
import { IFastPriceEvents } from "./FastPriceEvents.sol";
import { IVaultPriceFeed } from "../core/VaultPriceFeed.sol";
import { IPositionRouter } from "../core/PositionRouter.sol";
...
contract FastPriceFeed is ISecondaryPriceFeed, IFastPriceFeed, Governable {
    ...
    function _setLastUpdatedValues(uint256 _timestamp) private returns (bool) {
        ...
        require(_timestamp > block.timestamp-(_maxTimeDeviation));
        require(_timestamp < block.timestamp+(_maxTimeDeviation));
