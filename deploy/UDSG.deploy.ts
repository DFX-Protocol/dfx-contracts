...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) =>
{
	...
	const erc20 = await deploy(contract, { from: deployer, args: constructorParameters, log: false });
	console.log(`\x1B[32m${contract}\x1B[0m - ${erc20.newlyDeployed ? "deployed to" : "reused at"} \x1B[32m${erc20.address}\x1B[0m`);
};
